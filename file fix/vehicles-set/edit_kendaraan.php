<?php
    ...
    $plat = $_GET['plat'];
    $queryedit = mysqli_query($link,"SELECT * from kendaraan where plat = '$plat'");
    $data2 = mysqli_fetch_array($queryedit);
?>
...
<html>
    ...
    <div class="container">
     <div class="row">
        <div class="col-4"></div>
        <div class="col-4">
           <form action="p_up_ken.php" method="POST">
            <input type="hidden" name="plat_lama" value="<?php echo $data2['plat'];?>">
            	Gambar(link) <input  class="form-control" type="text" name="img"  value="<?php echo $data2['gambar'];?>"><br>
                No-Plat    <input class="form-control" type="text" name="plat" value="<?php echo $data2['plat'];?>"><br>
                Jenis    <input class="form-control" type="text" name="jenis" id="" value="<?php echo $data2['jenis'];?>"><br>
                Brand    <input class="form-control" type="text" name="brand" id="" value="<?php echo $data2['brand'];?>"><br>
                Merk <input class="form-control" type="text" name="merk" id="" value="<?php echo $data2['merk'];?>"> <br>
                Harga    <input class="form-control" type="text" name="harga" id="" value="<?php echo $data2['harga'];?>"><br>
